...
// TihonovMetod.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTihonovMetodApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTihonovMetodApp

CTihonovMetodApp::CTihonovMetodApp()
{
...
// Единственный объект CTihonovMetodApp

CTihonovMetodApp theApp;


// Инициализация CTihonovMetodApp

BOOL CTihonovMetodApp::InitInstance()
{
